...
<div class="container-fluid">
        <div class="card">
          <div class="card-header">Property Without Amenities</div>
          <div class="card-body">
          ...
          <div class="x_content">
            <table id="datatable" class="table table-striped table-bordered" style="text-align:center;">
              ...
              <tbody>
                  ...
                  <td>
                    <a href="{{route('property.addAmenitiesForm',$property->id)}}"><button class="btn btn-sm btn-info">Add Amenities</button></a>
                  ...
                  @endforeach
                  @if($count==0)
                    <div class="alert alert-info">'No Properties without amenities'</div>
                  @endif
              </tbody>
            </table>
          </div>
